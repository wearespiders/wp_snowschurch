...
if (get_option('mc_apikey') == '') {
	...
	<div>
		<form method="post" action="options-general.php?page=mailchimpSF_options">
			...
			<input type="submit" name="Submit" value="<?php esc_attr_e('Save & Check', 'mailchimp_i18n');?>" class="SubscribeButton" />
	...
	<tr>
		...
		<td>
			<form method="post" action="options-general.php?page=mailchimpSF_options">
				...
				<input type="submit" name="Submit" value="<?php esc_attr_e('Logout', 'mailchimp_i18n');?>" class="SubscribeButton" />
	    ...
	    <table style="min-width:400px">
			<tr>
				...
				<td>
					...
					<input type="submit" name="Submit" value="<?php esc_attr_e('Update List', 'mailchimp_i18n'); ?>" class="SubscribeButton" />
				</td>
			</tr>
			<tr>
				<td colspan="2">
...
<p class="submit">
	<form method="post" action="options-general.php?page=mailchimpSF_options">
		...
		<input type="submit" name="reset_list" value="<?php esc_attr_e('Reset List Options and Select again', 'mailchimp_i18n'); ?>" class="SubscribeButton" />
...
<input type="submit" value="<?php esc_attr_e('Update Subscribe Form Settings', 'mailchimp_i18n'); ?>" class="SubscribeButton" />
<table class="widefat">
    <tr valign="top">
